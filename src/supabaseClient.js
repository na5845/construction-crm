...
export const supabase = createClient(supabaseUrl, supabaseKey, {
  auth: {
    persistSession: true, // חובה: שמור את המשתמש בזיכרון
    autoRefreshToken: true, // חובה: רענן את החיבור אוטומטית
    detectSessionInUrl: true // חובה לספארי: זהה התחברות שמגיעה מלינק במייל
  }
});